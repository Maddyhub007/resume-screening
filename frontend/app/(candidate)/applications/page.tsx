...
import { ClipboardList, ChevronRight, Trash2, Loader2 } from "lucide-react";
            ...
            <Link key={app.id} href={`/candidate/applications/${app.id}`} className="card-hover p-4 flex items-center gap-4 group">
              ...
              <div className="flex items-center gap-3">
                ...
                {!["hired", "rejected", "withdrawn"].includes(app.stage) && (
                  ...
                  >
                    {withdrawMutation.isPending ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Trash2 className="w-3.5 h-3.5" />}
                  </button>
                )}
